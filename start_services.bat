@echo off
title SkillScavenge Control Panel
echo ============================================================
echo       ^^  SKILLSCAVENGE — MLOps Control Panel
echo ============================================================
echo.
...
start "SkillScavenge — FastAPI Backend" cmd /k "title FastAPI Backend && uvicorn app.main:app --reload"
timeout /t 2 /nobreak >nul
echo [2/2] Launching Streamlit Dashboard on http://localhost:8501 ...
start "SkillScavenge — Streamlit Dashboard" cmd /k "title Streamlit Dashboard && streamlit run streamlit_app/app.py"
echo.
echo ============================================================
